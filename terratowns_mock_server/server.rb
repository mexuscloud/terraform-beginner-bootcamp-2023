...
# you will never use a global variable in a production server. 
$home = {}

# This is a ruby class that include validations from ActiveRecords. 
...
class TerraTownsMockServer < Sinatra::Base
  ...
  post '/api/u/:user_uuid/homes' do
    ...
    # a begin/rescue is a try/catch, if an error occurs it produces a result. 
    begin
    ...
    # assign the payload to varaiables to make it easier to work with the code 
    name = payload["name"]
    ...
    # printing the varaiable out to console to make it easier 
    # to see or debug what we have inputed into this end point
    puts "name #{name}"
    ...
    # ensure validation check passes. otherwise, return the errors 
    unless home.valid?
    ...
    puts "uuid #{uuid}"
    # will mock save our data to our mock database which is juct a global varaiable
    $home = {
      uuid: uuid,
      name: name,
      town: town,
    ...
    # will just return the user uuid 
